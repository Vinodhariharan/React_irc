    ...
    <div className="wrapper">
      ...
      <nav>
        ...
        <div className="content">
          <ul className="links">
            <li>
              <a href='/productList' className="desktop-link">Plants</a>
            ...
            <li>
              <a href='/productList' className="desktop-link">Fertilizers</a>
            ...
            <li>
              <a href='/productList' className="desktop-link">Containers</a>
